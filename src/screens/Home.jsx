      ...
      <section style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'right' }}>
            <p style={{ fontSize: '0.7rem', opacity: 0.5, marginBottom: '2px', textTransform: 'uppercase' }}>الطالب المعد</p>
            <h3 style={{ fontWeight: '700', fontSize: '1.2rem', color: 'var(--secondary)', marginBottom: '0' }}>أحمد بدر عبد الهادي أبو عمر</h3>
            <p style={{ fontSize: '0.8rem', opacity: 0.7 }}>ID: 0150012120126</p>
          </div>
